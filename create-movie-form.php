...
<?php include "controller/create-movie.php" ?>
...
<button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#registerMovie">
 ...
 <!-- Modal -->
 <div class="modal fade container-fluid" id="registerMovie" tabindex="-1" aria-labelledby="registerMovieModalForm" aria-hidden="true">
            ...
            <div class="modal-body container-fluid">
              <form class="row g-3" action="" enctype="multipart/form-data" method="POST">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="age_classification" id="age_classification" required>
                </div>
                
                <div class="col-12">
                  <label for="synopsis" class="form-label">Sinopsis</label>
                  <textarea class="form-control" name="synopsis" id="synopsis" cols="30" rows="3" required></textarea>
                </div>
                <div class="col-12">
                ...
                <div class="col-md-4">
                  ...
                  <input type="number" class="form-control" id="punctuation" name="punctuation" min="1" max="10" step="1" placeholder="Del 1 al 10" required>  
                </div>
                <div class="col-md-4">
                  <label for="duration" class="form-label">Duración</label>
                  <input type="number" class="form-control" id="duration" name="duration" min="0" max="300" step="1"placeholder="En minutos" required>
                </div>
                <div class="col-md-4">
